...
function DataResults(props) {
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_5___default.a.Fragment, null, value.map(function (item) {
    return __jsx("div", {
      key: item[0],
      __self: _this,
      __source: {
    ...
    }, item[0]), needColon ? ': ' : ' ', __jsx(NumberValue, {
      value: item[1],
      __self: _this,
      __source: {
        fileName: _jsxFileName,
...
//# sourceMappingURL=visualization.js.96471b8d67c3c45d6aac.hot-update.js.map