...
var Visualization = /*#__PURE__*/function (_React$Component) {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Visualization, [{
    ...
    value: function parseGithubData(result, config) {
      ...
      var d = new Date(r.commit.author.date);
      console.log(d);
      var tzoffset = d.getTimezoneOffset() * 60000; //offset in milliseconds

      var localISOTime = new Date(d - tzoffset).toISOString().slice(0, -1); // => '2015-01-26T06:40:36.181'

      console.log('localISOTime');
      console.log(localISOTime);
      var n = moment__WEBPACK_IMPORTED_MODULE_8___default()(localISOTime).format('MM/DD/YYYY, hh:hh a');
      console.log(n);
      var f = moment__WEBPACK_IMPORTED_MODULE_8___default()(localISOTime).fromNow();
      console.log(f);
...
//# sourceMappingURL=visualization.js.70d8ca82e73ba820b521.hot-update.js.map