    ...
    value: function componentDidMount() {
      ...
      dc.getDataPromise('https://raw.githubusercontent.com/nychealth/coronavirus-data/master/summary.csv').then(function (result) {
        ...
        var noAsteriks = JSON.parse(JSON.stringify(data).replace(/\*/g, '')).map(function (arr) {
          var delta = arr; // eslint-disable-next-line no-console

          console.log(delta);
          if (delta) delta[0] = delta[0].replace('NYC_', '').split('_').join(' ').replace(/\w\S*/g, function (txt) {
...
//# sourceMappingURL=visualization.js.b3a5c7055fa7cd4fa3cb.hot-update.js.map